 ...
 */
	public function view($id = null) 
	{
		...
		$Staticpage = $this->Staticpage->read(null, $id);
		$page_title =  $Staticpage['Staticpage']['meta_title'];
		$page_description  =  $Staticpage['Staticpage']['meta_description'];
		$page_keyword =  $Staticpage['Staticpage']['meta_keyword'];
