    ...
    e.fn.uploadFile = function (n) {
        ...
        function h(t, n, r) {
            for (var i = 0; i < r.length; i++) {
                ...
                d.filename.html(v);
                var m = e("<form  class='" + n.formGroup + "' method='" + t.method + "' action='" + t.url + "' enctype='" + t.enctype + "'></form>");
                m.appendTo("body");
                var b = [];
                b.push(r[i].name);
                y(m, s, d, b, n, r[i]);
        ...
        function g(t, n) {
            ...
            this.abort = e("<div class='ajax-file-upload-red ajax-file-upload-abort " + t.formGroup + "'></div>").appendTo(this.statusbar).hide();
            ...
            this.done = e("<div class='ajax-file-upload-green'></div>").appendTo(this.statusbar).hide();
        ...
        function y(n, r, i, s, o, u) { alert("sdsd");
            var f = null;
            var l = {
                cache: false,
                contentType: false,
