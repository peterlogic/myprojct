        ...
        <div id="dyn" class="hiddenpars">
             <?php echo $this->Form->create('User',array('action'=>'admin_add','id'=>'validate')); ?>
                <div class="formRow">
                    ...
                    <div class="grid9">
                    <?php echo $this->Form->input('username', array('label'=>"",'type'=>'text','class'=>'validate[required]','required'));?>
                    </div>
                </div>
                ...
                <div class="formRow">
                    ...
                    <div class="grid9">
                    <?php echo $this->Form->input('password', array('label'=>"",'type'=>'password','required','minlength'=>'3','maxlength'=>'6'));?>
                    </div>
                </div>  
            ...
            <div class="formRow">
                    ...
                    <div class="grid9">
                    <?php echo $this->Form->input('contact', array('label'=>"",'type'=>'text','class'=>'numeric','maxlength'=>'20'));?>
