                ...
                <tbody>
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            if($status==1){
                            echo $this->Form->postLink($this->Html->image('/img/test-pass-icon.png',array('height'=>13,'width'=>13)),array('action'=>'deactive',$user['User']['id']),array('escape'=>false,'class'=>'tablectrl_small bDefault tipS','title'=>'Deactivate','style'=>'height: '));
                            } else if($status==0){
                            echo $this->Form->postLink($this->Html->image('/img/test-fail-icon.png',array('height'=>13,'width'=>13)),array('action'=>'active',$user['User']['id']),array('escape'=>false,'class'=>'tablectrl_small bDefault tipS','title'=>'Activate','style'=>'height: '));
                            }?> 
                            <?php
                            if($user_data == 1){
