        ...
        <div id="dyn" class="hiddenpars">
             <?php echo $this->Form->create('Staticpage',array('method'=>'Post','type'=>'file','id'=>'validate')); ?>
                ...
                <div class="formRow">
				  ...
				  <div class="formRow">
                    <div class="grid3"><label>Meta Title:<span class="red">*</span></label></div>
                    <div class="grid9">
                    <?php echo $this->Form->input('meta_title', array('label'=>"",'type'=>'text'));?>
                    </div>
                </div>
				
				  <div class="formRow">
                    <div class="grid3"><label>Meta Description:<span class="red">*</span></label></div>
                    <div class="grid9">
                    <?php echo $this->Form->input('meta_description', array('label'=>"",'type'=>'textarea','id'=>'conta','style'=>'height:120px;width:50%;'));?>
                    </div>
                </div>
				
				  <div class="formRow">
                    <div class="grid3"><label>Meta Keyword:<span class="red">*</span></label></div>
                    <div class="grid9">
                    <?php echo $this->Form->input('meta_keyword', array('label'=>"",'type'=>'text'));?>
                    </div>
                </div>
