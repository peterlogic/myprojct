...
<div id="content">
        ...
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                ...
                <li><a href="<?php echo $this->Html->url(array('controller'=>'Blogs','action'=>'admin_view')); ?>">Blogs Management</a></li>
                 <li class="current"><a href="javascript:void:(0)">Add Blog</a></li>
            </ul>
        </div>
    </div>
    ...
    <div class="wrapper">
        ...
        <div class="whead"><h6>Add Blog</h6></div>
        <div id="dyn" class="hiddenpars">
            
	<?php	 echo $this->Form->create('Blogs', array('controller' => 'blogs','action'=>'add','enctype'=>'multipart/form-data' ));?>
                			 
                <div class="formRow">
                    <div class="grid3"><label>Title:</label></div>
                    <div class="grid9">
                    <input type="text" name="data[Blog][title]" required >                   
                 ...
                 <div class="formRow">
                    ...
                    <div class="grid9">
                 <textarea name="data[Blog][content]" style="width: 464px; height: 101px;" required></textarea>
                 ...
                 <div class="formRow">
					...
					<input type="file" name="data[Blog][image]" style="margin-left:30px;" id="fileUpload" required="required" />
				 ...
				 <div class="formRow">
                    ...
                    <div class="grid9">
                  <input type="text"  name="data[Blog][link]"  id="date"   required />
